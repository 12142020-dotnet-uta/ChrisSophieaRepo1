...
namespace RpsGameWithDb
{
    ...
    {
        static RpsDbContext db = new RpsDbContext();
        ...
        public Player CreatePlayer(string fName = "null", string lName = "null")
        {
            ...
            p1 = db.players.Where(x => x.Fname == fName && x.Lname == lName).FirstOrDefault();
        ...
        public Round PlayRound(Match match, Choice computerChoice, Choice userChoice)
        {
            ...
            if (userChoice == computerChoice)   // is the playes tied
            {
                ...
                match.RoundWinner();
                db.SaveChanges(); // send in the player who won. empty args means a tie round
            }
