...
namespace MyStore.Data.Migrations
{
    ...
    [Migration("20210111160515_applicationuserdefaultstorefkaddingback")]
    partial class applicationuserdefaultstorefkaddingback
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyStore.Models.Inventory", b =>
                {
            ...
            modelBuilder.Entity("MyStore.Models.ItemCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyStore.Models.ItemPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyStore.Models.Inventory", b =>
                {
                    b.HasOne("MyStore.Models.Item", "Item1")
                        .WithMany("Inventories")
                        .HasForeignKey("Item1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyStore.Models.Store", "Store1")
                        .WithMany("Inventories")
            ...
            modelBuilder.Entity("MyStore.Models.Item", b =>
                {
                    b.HasOne("MyStore.Models.ItemCategory", "ItemCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("MyStore.Models.ItemPurchase", b =>
                {
                    b.HasOne("MyStore.Models.Item", "Item1Item")
                        .WithMany("ItemPurchases")
                        .HasForeignKey("Item1ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyStore.Models.Purchase", "PurchasesPurchase")
            ...
            modelBuilder.Entity("MyStore.Models.Purchase", b =>
                {
                    b.HasOne("MyStore.Models.ApplicationUser", "Customer1")
                        .WithMany()
