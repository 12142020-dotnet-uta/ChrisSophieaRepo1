...
namespace P0_ChrisSophiea.Tests
{
    public class UnitTest1
    {
        ...
        // public void GetPurchasesByCustomerRetrievesPurchasesByCustomerInDB(){}

        // public void GetPurchasesByStoreRetrievesPurchasesByStoreInDB(){}
